...
public class HorizontalListView extends AdapterView<ListAdapter> implements
	...
	private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
		...
		public boolean onSingleTapUp(MotionEvent e) {
			...
			/*
			 * View view = ((HorizontalAdapter)mAdapter).getClickedView();
			 * Intent intent = new Intent(); String ruta =
			 * (String)view.getTag(); intent.putExtra("ruta", ruta);
			 * intent.setClass(getContext(), LocalizarActivity.class);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		String ruta = (String) view.getTag();
		intent.putExtra("ruta", ruta);
		intent.setClass(getContext(), LocalizarActivity.class);
		//intent.setClass(getContext().getApplicationContext(), LocalizarActivity.class);
		getContext().startActivity(intent);
	}
